                        ...
                        <tbody>
                            @forelse($transactions as $processing)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-secondary-button type="button" x-on:click="$dispatch('open-modal', 'transaction-details-{{ $processing->id }}')">
                                            {{ __('View') }}
                                        </x-secondary-button>
                                    </td>
                                </tr>

                                <x-modal name="transaction-details-{{ $processing->id }}" maxWidth="2xl">
                                    <div class="p-6">
                                        <div class="border-b pb-4 mb-4">
                                            <div class="flex justify-between items-center">
                                                <div>
                                                    <h2 class="text-lg font-extrabold text-gray-800">{{ __('Transaction Details') }}</h2>
                                                ...
                                                <div>
                                                    <span class="monthly-category {{ $categoryClass }}">{{ $client->client_category }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex justify-end mt-6 pt-4 border-t border-gray-100">
                                            <x-secondary-button type="button" x-on:click="$dispatch('close-modal', 'transaction-details-{{ $processing->id }}')">
                                                {{ __('Close') }}
                                            </x-secondary-button>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="monthly-empty">
