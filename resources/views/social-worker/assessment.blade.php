                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="mb-6 bg-slate-50 p-4 rounded-xl text-sm border border-slate-100 flex flex-col gap-3">
                                            ...
                                            <div class="border-t pt-2.5">
                                                <span class="text-xs text-gray-400 block uppercase font-bold">{{ __('Type of Assistance') }}</span>
                                                <span class="font-semibold text-gray-700 block mt-1 leading-normal">{{ $item->client->type_of_assistance }}</span>
                                            </div>
                                        </div>
