        ...
        <div class="dashboard__container">
            ...
            <div class="dashboard-banner">
                <div class="dashboard-banner__content">
                    <div class="dashboard-banner__badge">DSWD Social Worker Portal</div>
                    <h1 class="dashboard-banner__title">Welcome back, {{ Auth::user()->first_name }}!</h1>
                    <p class="dashboard-banner__description">
                        Assess queued clients, compile interview findings, identify recommendations, and log case indicators for general social work services.
                    </p>
                </div>
                ...
                <div class="dashboard-layout__main">
                    ...
                    <div class="queue-card">
                        <div class="queue-card__header">
                            <div>
                                <h2 class="queue-card__title">Pending Assessment Queue</h2>
                            </div>
                ...
                <div class="dashboard-layout__sidebar">
                    ...
                    <div class="actions-card">
                        ...
                        <div class="actions-card__body">
                            <a href="{{ route('social-worker.assessment') }}" class="actions-card__btn">
                                ...
                                <div>
                                    <div class="actions-card__btn-title">Assessment Queue</div>
                                    <div class="actions-card__btn-desc">Evaluate queued cases.</div>
                                </div>
                            </a>

                            <a href="{{ route('social-worker.returned') }}" class="actions-card__btn">
                                <div class="actions-card__btn-icon">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                                ...
                                <div>
                                    <div class="actions-card__btn-title">Returned Actions</div>
                                    <div class="actions-card__btn-desc">Refactor returned applications.</div>
                                </div>
                            </a>
                        </div>
                    </div>
