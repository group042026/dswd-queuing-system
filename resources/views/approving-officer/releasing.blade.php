        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="val-banner">
                <div class="val-banner__content">
                    <div class="val-banner__badge">DSWD Approving Officer Portal</div>
            ...
            <div class="filter-card">
                <form method="GET" action="{{ route('approving-officer.releasing') }}" class="flex items-end gap-3 flex-wrap">
                        ...
                        @foreach($pendingReleasing as $item)
                            <x-modal name="release-modal-{{ $item->id }}" maxWidth="lg">
                                <div class="p-6">
                                    ...
                                    <form method="POST" action="{{ route('approving-officer.releasing.release', $item->id) }}">
                                        @csrf
                                        <div class="mb-4">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        window.Echo.channel('receptionist-dashboard')
            .listen('.dashboard.updated', () => {
                ...
                fetch(`{{ route('approving-officer.releasing.data') }}?${params.toString()}`)
