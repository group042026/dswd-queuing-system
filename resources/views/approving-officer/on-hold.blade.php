            ...
            <div class="hold-banner">
                <div class="hold-banner__content">
                    ...
                    <p class="hold-banner__description">
                        {{ __('Monitor applications temporarily placed on hold while waiting for additional verification or follow-up requirements.') }}
                    </p>
                </div>
                ...
                <div class="mb-6 flex justify-between items-center border-b pb-4">
                    <div>
                        <h3 class="text-lg font-extrabold text-gray-800">
                            {{ __('Applications Currently On Hold') }}
                        </h3>

                        <p class="text-xs text-gray-500 mt-1">
                            {{ __('Applications temporarily waiting for additional verification or follow-up requirements.') }}
                        </p>
                    </div>
                </div>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-row items-start gap-2">
                                            ...
                                            <span class="rounded-full bg-orange-100 px-2 py-1 text-[10px] font-extrabold uppercase text-orange-700 hold-status-badge">
                                                {{ __('On Hold') }}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <form
                                            method="POST"
                                            action="{{ route('approving-officer.review.resume', $item) }}"
                                        >
                                            @csrf
                                            @method('PATCH')
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    >
                                        {{ __('No applications are currently on hold.') }}
                                    </td>
                                </tr>
