        ...
        <div class="dashboard__container">
            <div class="dashboard-banner">
                <div class="dashboard-banner__content">
                    <div class="dashboard-banner__badge">DSWD Cashier Portal</div>
                    <h1 class="dashboard-banner__title">Welcome back, {{ Auth::user()->first_name }}!</h1>
                    <p class="dashboard-banner__description">
                        Process and confirm the release of approved assistance to queued clients.
                    </p>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card stat-card--yellow">
                    <div class="stat-card__content">
                        ...
                        <span class="stat-card__value">{{ $pendingReleasingCount }}</span>
                    </div>
                ...
                <div class="stat-card stat-card--emerald">
                    <div class="stat-card__content">
                        <span class="stat-card__label">Released Today</span>
                        <span class="stat-card__value">{{ $releasedTodayCount }}</span>
                    </div>
                ...
                <div class="dashboard-layout__main">
                    <div class="queue-card">
                        <div class="queue-card__header">
                            <div>
                                <h2 class="queue-card__title">Pending Releasing Queue</h2>
                            </div>
                        ...
                        <div class="queue-card__body">
                            @if($liveQueue->isEmpty())
                                <div class="queue-card__empty-state">
                                    ...
                                    <p class="text-sm">There are no clients waiting for releasing today.</p>
                                </div>
                            @else
                ...
                <div class="dashboard-layout__sidebar">
                    <div class="actions-card">
                        ...
                        <div class="actions-card__body">
                            <a href="{{ route('approving-officer.releasing') }}" class="actions-card__btn">
                                ...
                                <div>
                                    <div class="actions-card__btn-title">Releasing Portal</div>
                                    <div class="actions-card__btn-desc">Process approved assistance releases.</div>
                                </div>
                            </a>
                        </div>
                    </div>
